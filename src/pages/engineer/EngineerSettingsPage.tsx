...
const EngineerSettingsPage: React.FC = () => {
  ...
  return (
    <MainLayout title="Settings" userRole="engineer" userName="Jane Smith">
      <Box sx={{ mb: 4 }}>
          ...
          >
            ...
            <FormGroup sx={{ mt: 2 }}>
              ...
              <FormControlLabel
                control={
                  <Switch 
                    checked={notificationSettings.reportComments} 
                    onChange={handleNotificationChange} 
                    name="reportComments" 
                    color="primary"
                  />
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              <FormContainer
                ...
                subtitle="Update your professional and contact information"
                fields={[
                  ...
                  { name: 'licenseNumber', label: 'Professional License Number', required: true },
