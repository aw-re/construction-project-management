...
const mockTasks = [
  ...
  { 
    ...
    description: 'Review and approve structural design documents for compliance with building codes and standards.',
  ...
  { 
    ...
    description: 'Design plumbing system layout for all floors including water supply, drainage, and fixtures.',
  ...
  { 
    ...
    description: 'Develop detailed plan for HVAC system installation including ductwork, equipment, and controls.',
  ...
  { 
    ...
    description: 'Analyze site survey data and prepare report on topography, boundaries, and existing structures.',
  ...
  { 
    id: 7, 
    title: 'Roof Design Specifications', 
    description: 'Create detailed specifications for roof design including materials, slopes, and drainage systems.',
    project: 'Central Park Office Building',
    dueDate: '2025-04-08',
    priority: 'medium',
    status: 'done',
...
const EngineerTasksPage: React.FC = () => {
  ...
  return (
    <MainLayout title="Tasks" userRole="engineer" userName="Jane Smith">
      <Box sx={{ mb: 4 }}>
