...
const mockNotifications = [
  { 
    ...
    message: 'You have been assigned to Concrete Pouring - Level 5 task',
  ...
  { 
    ...
    message: 'John Doe commented on Concrete Pouring - Level 5 task: "Please ensure proper curing time for the concrete"',
    project: 'Skyline Tower Construction',
  ...
  { 
    ...
    message: 'You have been invited to join Harbor View Hotel project',
  ...
  { 
    ...
    message: 'Plumbing Installation - Basement task is due in 3 days',
  ...
  { 
    ...
    message: 'Your Excavation Documentation report has been approved by John Doe',
    project: 'Skyline Tower Construction',
  ...
  { 
    ...
    message: 'Sarah Williams commented on Site Preparation Completion Report: "Great work on completing the site preparation ahead of schedule."',
  ...
  { 
    ...
    message: 'Your invitation to Metro City Hospital Extension project has been accepted',
    project: 'Metro City Hospital Extension',
    date: '2025-03-16T13:30:00Z',
    read: true
  }
];

const ContractorNotificationsPage: React.FC = () => {
  ...
  return (
    <MainLayout title="Notifications" userRole="contractor" userName="Mike Johnson">
      <Box sx={{ mb: 4 }}>
